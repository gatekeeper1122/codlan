...
int _main(struct thread *td) {
	...
	strcpy(data.beta_warning, "COD:Online is a Beta (PB1.0) !");
	...
	strcpy(data.ps4_banned_msg, "Your PS4 have been banned from COD:Online.\nPlease close the game.");
	strcpy(data.service_offline_msg, "COD:Online is currenly offline\nPlease close the game.");
	strcpy(data.error_occured_msg, "An error occured in COD:Online.\nPlease contact an Administrator");
	strcpy(data.welcome_msg, "Welcome in COD:Online !");
